...
//    var storSvms:ArrayList<CvSVM> ?= null
//
//    private var resultObjects: MutableMap<String, Mat>? = null
//
//    //存放训练图片词典
//    private var vocab:Mat ?= null
//
//    var clusters: Int = 0
//
//    // 构造函数
...
//        // 训练得到的SVM
//        storSvms =  ArrayList<CvSVM>(categoriesSize)
//
//        featureDetector = FastFeatureDetector()
//
...
//            fileStorage.writeObj("vocabulary",vocab)
...
//            var tempVacab = Mat(tempVocabulary["vocabulary"])
//
//            //tempVacab = tempVocabulary.get("vocabulary")
...
//                }
//                storSvms!![i].train(temSamples, responses,Mat(),Mat(),svmParams)
//                val svmFilename = DATA_FOLDER + categoryName[i] + "SVM.xml"
//                storSvms!![i].save(svmFilename)
//            }
//        }
//    }
//
...
//                    } else {
//                        if (sign == 0) {
//                            val scoreValue = storSvms!![i].predict(test, true)
//                            val classValue = storSvms!![i].predict(test, false)
//                            sign = if (scoreValue < 0.0f == classValue < 0.0f) 1 else -1
//                        }
//                        curConfidence = sign * storSvms!![i].predict(test,true);
//                    }
